...
info     =$1b;*=*+2          ; controller job information variable
fmhdpt   =$1b
...
chksum   =$3a
tsttrk   =$3b
switch   =$3b;*=*+1          ; burst command switch
cpmit    =$3c
drive    =$3d
cdrive   =$3e
jobn     =$3f
...
btab     =$52
gtab     =$56
dkmode   =$5e;*=*+1          ; burst status
as       =$5e
ctl_cmd  =$5f
af       =$5f
aclstp   =$60
minsek   =$60;*=*+1          ; burst min. sector #
rsteps   =$61
maxsek   =$61;*=*+1          ; "  "  max. "    "
nxtst    =$62
minstp   =$64
